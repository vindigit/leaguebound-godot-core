...
- **Owner-approved free-throw clock contract (2026-09-15):** administration and awarded free-throw attempts consume neither game-clock nor shot-clock time. Eligible attempts finish at the award timestamp, including an award at the horn; no artificial positive clock floor is introduced. A subsequent live rebound or play consumes time through the ordinary live-action path. Presentation duration is separate from playing-time and fatigue accounting.
